	...
	<div class="main_div">
		<div class="logo_dv">
			<div class="lg_main_dv">
				<img src="images/vendor.png" style="max-width:200px;">
			</div>
			<div class="vendor_add">
				<p><b>9 Yards</b></p>
				<p>2-2-2390/23, Banjara Hills, Hyderabad,Telangana-44, Ph: 040-23554749</p>
			</div>
		...
		<div class="content" style="padding-top:40px;">
			<div class="alert alert-error"  style="text-align:center;">
				<img src="images/failure.png" style="width:100px;">
				<span><b>Sorry!</b>We could not process your payment at this moment!Please try again after sometime</span>
			</div>
		</div>
		<div class="footer">
			<div class="ftr_left">
